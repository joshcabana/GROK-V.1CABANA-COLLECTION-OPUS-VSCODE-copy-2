  ...
  return (
    <div className={cn('space-y-2', fullWidth && 'w-full')}>
      <button
        ...
        onClick={handleClick}
        className={cn(
          'inline-flex w-full items-center justify-center gap-2 rounded-full bg-ink px-6 py-3 text-sm font-semibold uppercase tracking-[0.12em] text-white transition-transform duration-300 active:scale-[0.98] motion-reduce:transform-none',
