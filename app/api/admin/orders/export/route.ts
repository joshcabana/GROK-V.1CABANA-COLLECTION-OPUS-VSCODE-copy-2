...
// NOTE: This in-memory rate limiter is for basic protection. In serverless environments
// (like Vercel), this state is NOT shared across instances and is frequently reset.
// For robust production rate limiting, use a persistent store like Upstash Redis.
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (error instanceof EnvConfigError) {
      return NextResponse.json(
        {
          error: 'Order export is unavailable due to missing configuration.',
